...
<html lang="fr">
    ...
    <body>
        ...
        <main>
            <?php 
                includeArticleHeader($game[0]["id"], $game[0]["title"], $article[0]["title"], $author[0]["username"], $article[0]["authorID_article"]);
            ...
            <section class="review-section">
                ...
                <div class="add-review-container">
                    ...
                    <form action="/src/actions/addReview.php?id=<?php echo $article_id ?>" method="post" class="add-review-form">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="rating" placeholder="Note sur 100" min="0" max="100">
                        </div>
                        <div class="form-group">
                ...
                <?php
                    ...
                    for ($i = 0; $i < count($comments); $i++) {
                        ...
                        includeReview($user["id"], $user["username"], profilePicture(false, $user["id"]), $comment["creationDate"], $comment["hoursPlayed"], $comment["rating"], $comment["title"], $comment["content"], $game[0]["title"], $comment["id"], $article_id);
                    }
