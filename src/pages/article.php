            ...
            <section class="review-section">
                ...
                <?php
                    ...
                    for ($i = 0; $i < count($comments); $i++) {
                        ...
                        includeReview($user["username"], profilePicture(false, $user["id"]), $comment["creationDate"], $comment["hoursPlayed"], $comment["rating"], $comment["title"], $comment["content"], $game[0]["title"], $comment["id"], $article_id);
                    }
