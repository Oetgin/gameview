...
// __________Document root__________
define('DOCUMENT_ROOT', $_SERVER['DOCUMENT_ROOT']);


// __________Meta tags__________
define('META_DESCRIPTION', 'Site de critique de jeux vidéo avec des articles, des avis d\'utilisateurs et des fonctionnalités de recherche.');
define('META_KEYWORDS', 'jeux vidéo, critiques, avis, articles, plateformes, genres, gameplay');
define('META_AUTHOR', "Ginguené Théo, Girot Balthazar");
